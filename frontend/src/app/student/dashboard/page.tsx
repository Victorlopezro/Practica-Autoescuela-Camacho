        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-3 gap-4">
            <Card className="text-center">
              <p className="text-headline-md font-bold text-primary">{profile.remainingClasses}</p>
              <p className="text-label-caps text-on-surface-variant mt-1">Clases restantes</p>
            </Card>
            <Card className="text-center">
              <p className="text-headline-md font-bold text-secondary">{'65%'}</p>
              <p className="text-label-caps text-on-surface-variant mt-1">Progreso teórico</p>
            </Card>
            <Card className="text-center">
              <p className="text-headline-md font-bold text-tertiary">{'Mañana'}</p>
              <p className="text-label-caps text-on-surface-variant mt-1">Próxima clase</p>
            </Card>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
            ...
            <div className="md:col-span-8 bg-white rounded-xl border border-outline-variant/30 p-6 shadow-[0_2px_4px_rgba(0,0,0,0.05)] relative overflow-hidden">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mt-8">
                <div><span className="text-on-surface-variant text-[10px] text-label-caps">CLASES</span><p className="text-headline-md font-bold text-on-surface">{profile.remainingClasses}/32</p></div>
