...
const navItems = [
  ...
  { href: '/admin/scheduling/rules', label: 'Reglas', icon: 'rule' },
...
const breadcrumbMap: Record<string, { label: string; breadcrumbs: { label: string; href?: string }[] }> = {
  ...
  '/admin/scheduling/rules': { label: 'Gestión de Reglas', breadcrumbs: [{ label: 'INICIO', href: '/admin/dashboard' }, { label: 'REGLAS' }] },
