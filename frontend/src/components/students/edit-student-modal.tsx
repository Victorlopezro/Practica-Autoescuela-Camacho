...
interface Props {
  ...
  onClose: () => void;
  onSuccess: () => void;
  student: StudentWithUserDto;
}

export function EditStudentModal({ open, onClose, onSuccess, student }: Props) {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      await services.student.updateStudent(student.id, payload);
      onSuccess();
      handleClose();
    } catch (err) {
  ...
  return (
    <Modal open={open} onClose={handleClose} title="Editar Alumno">
