...
export class CreateSchedulingRuleDto {
  @ApiProperty({ description: 'Rule name', minLength: 3, maxLength: 100, example: 'Horario laboral' })
  @IsString()
  @MinLength(3)
  @MaxLength(100)
  name!: string;
  ...
  @ApiPropertyOptional({
    ...
    example: { conditions: [{ field: 'time', operator: 'gte', value: '08:00' }], logic: 'AND' },
  })
  @IsOptional()
  @IsObject()
  ...
  @ApiPropertyOptional({ description: 'Priority (lower = evaluated first)', default: 100, minimum: 0 })
  @IsOptional()
  @IsInt()
  @Min(0)
  priority?: number;
