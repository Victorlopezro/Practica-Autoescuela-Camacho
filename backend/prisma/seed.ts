...
async function main() {
  ...
  const students = [
    {
      ...
      student: { id: 's-0001', remainingClasses: 10, balanceHistory: [{ amount: 15000, reason: 'Pago inicial 10 clases', timestamp: '2026-05-01T10:00:00Z', adjustedBy: 'admin' }, { amount: -3000, reason: 'Clase #1 usada', timestamp: '2026-05-05T09:00:00Z', adjustedBy: 'system' }] },
    },
    {
      user: { id: 'u-stud-0002', username: 'lfernandez', name: 'Laura', lastName: 'Fernández', email: 'laura.fernandez@email.com', phone: '600333002' },
      student: { id: 's-0002', remainingClasses: 5, balanceHistory: [{ amount: 7500, reason: 'Pago 5 clases', timestamp: '2026-05-02T11:00:00Z', adjustedBy: 'admin' }] },
    },
    {
      user: { id: 'u-stud-0003', username: 'mmartinez', name: 'Mario', lastName: 'Martínez', email: 'mario.martinez@email.com', phone: '600333003' },
      student: { id: 's-0003', remainingClasses: 20, balanceHistory: [{ amount: 30000, reason: 'Pago inicial 20 clases', timestamp: '2026-04-28T09:00:00Z', adjustedBy: 'admin' }] },
    },
    {
      user: { id: 'u-stud-0004', username: 'asanchez', name: 'Sofía', lastName: 'Sánchez', email: 'sofia.sanchez@email.com', phone: '600333004' },
      student: { id: 's-0004', remainingClasses: 3, balanceHistory: [{ amount: 9000, reason: 'Recarga 5 clases', timestamp: '2026-05-10T16:00:00Z', adjustedBy: 'admin' }, { amount: -1500, reason: 'Clase #1 usada', timestamp: '2026-05-12T10:00:00Z', adjustedBy: 'system' }, { amount: -1500, reason: 'Clase #2 usada', timestamp: '2026-05-14T10:00:00Z', adjustedBy: 'system' }] },
    },
    {
      user: { id: 'u-stud-0005', username: 'dtorres', name: 'Diego', lastName: 'Torres', email: 'diego.torres@email.com', phone: '600333005' },
      student: { id: 's-0005', remainingClasses: 8, balanceHistory: [{ amount: 12000, reason: 'Pago 8 clases', timestamp: '2026-05-08T14:00:00Z', adjustedBy: 'admin' }] },
    },
    {
      user: { id: 'u-stud-0006', username: 'cruz', name: 'Carmen', lastName: 'Ruiz', email: 'carmen.ruiz@email.com', phone: '600333006' },
      student: { id: 's-0006', remainingClasses: 15, balanceHistory: [{ amount: 22500, reason: 'Pago 15 clases', timestamp: '2026-05-03T12:00:00Z', adjustedBy: 'admin' }] },
    },
  ];
  ...
  for (const s of students) {
    ...
    await prisma.student.upsert({
      ...
      update: { remainingClasses: s.student.remainingClasses, balanceHistory: s.student.balanceHistory },
      create: {
        id: s.student.id,
        userId: s.user.id,
